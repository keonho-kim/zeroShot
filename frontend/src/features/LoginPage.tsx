...
export function LoginPage() {
  ...
  return (
    <div className="flex min-h-[calc(100vh-3rem)] items-center justify-center">
      <Card className="w-full max-w-3xl space-y-5 p-8">
        <div>
          <p className="text-sm font-semibold uppercase tracking-[0.25em] text-[var(--primary)]">Phase Login</p>
          <h1 className="mt-2 text-4xl font-black tracking-tight">Auth를 먼저 준비하세요</h1>
        ...
        <div className="rounded-2xl border border-[var(--danger-border)] bg-[var(--danger-surface)] p-4 text-sm text-[var(--danger-foreground)]">
