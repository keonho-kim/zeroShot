              ...
              <>
                ...
                {buildSource === "product-md" ? (
                  <div className="build-upload-panel">
                    ...
                    />
                    <Textarea value={productContent} onChange={(event) => setProductContent(event.target.value)} placeholder="제품 목적, 핵심 화면, 필요한 동작을 입력하세요." />
                  </div>
                ) : null}
          ...
          <Card className="agent-panel flex flex-col gap-4 bg-[var(--panel)]">
            ...
            <div>
              <p className="text-sm text-[var(--muted-foreground)]">
                선택한 프로젝트 루트에 제품 설명과 업데이트 요청을 저장한 뒤 update 파이프라인을 실행합니다.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-2">
              ...
              />
              <Textarea value={updateContent} onChange={(event) => setUpdateContent(event.target.value)} placeholder="변경하거나 보완할 내용을 입력하세요." />
            </div>
