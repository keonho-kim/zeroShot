...
export function visiblePreludePrompt(params: {
  ...
  return [
    ...
    `Respond in ${language}.`,
    "Write a short user-facing work note before the structured result is generated.",
    "Describe the concrete product files, UI artifacts, or implementation context you are about to inspect.",
